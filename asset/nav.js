...
nav.list[0] = [{
  ...
  name: "西邮生活", icon: "fa-solid fa-school", item: [
    ...
    { text: "一网通办", desc: "新版个人中心", icon: "fa-solid fa-street-view", link: "http://i.xupt.edu.cn/" },
    { text: "<del>个人中心</del>", desc: "校园信息门户", icon: "fa-solid fa-street-view", link: "http://i.xiyou.edu.cn/" },
